...
import app.thecity.widget.NewsInfoCard;
...
public class AdapterNewsInfo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public NewsInfoCard card;

        public OriginalViewHolder(NewsInfoCard card) {
            super(card);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            NewsInfoCard v = new NewsInfoCard(parent.getContext());
